...
var taskInput = document.querySelector("#adding-tasks-functional__input"); // Add a new task.
var addButton = document.querySelector(".adding-tasks-functional__button"); // adding button
...
var addTask = function() {
  ...
  // Create a new list item with the text from the #adding-tasks-functional__input:
